...
import (
	...
	"dagger/terrabox/internal/querybuilder"
)
...
func (r *Client) LoadUtilsFromID(id UtilsID) *Utils {
	q := r.query.Select("loadUtilsFromID")
	q = q.Arg("id", id)
...
func (r *Utils) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadUtilsFromID(UtilsID(id))
	return nil
}

func (r *Utils) WithDotEnvSecret(ctr *Container, data *Secret) *Container {
	assertNotNil("ctr", ctr)
	assertNotNil("data", data)
	q := r.query.Select("withDotEnvSecret")
	q = q.Arg("ctr", ctr)
	q = q.Arg("data", data)
