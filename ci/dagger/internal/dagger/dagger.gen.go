...
func (r *Node) OciBuild(ctx context.Context, registries []string, opts ...NodeOciBuildOpts) ([]string, error) {
	...
	for i := len(opts) - 1; i >= 0; i-- {
		// `folderArtifactNames` optional argument
		if !querybuilder.IsZeroValue(opts[i].FolderArtifactNames) {
			q = q.Arg("folderArtifactNames", opts[i].FolderArtifactNames)
		}
		// `folderArtifacts` optional argument
		if !querybuilder.IsZeroValue(opts[i].FolderArtifacts) {
			q = q.Arg("folderArtifacts", opts[i].FolderArtifacts)
		}
		// `fileArtifactNames` optional argument
		if !querybuilder.IsZeroValue(opts[i].FileArtifactNames) {
			q = q.Arg("fileArtifactNames", opts[i].FileArtifactNames)
		}
		// `fileArtifacts` optional argument
		if !querybuilder.IsZeroValue(opts[i].FileArtifacts) {
			q = q.Arg("fileArtifacts", opts[i].FileArtifacts)
		}
...
type NodeParallelTestOpts struct {
	//
...
func (r *Node) ParallelTest(ctx context.Context, cmds [][]string, opts ...NodeParallelTestOpts) (Void, error) {
	...
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `cacheArtifactNames` optional argument
		if !querybuilder.IsZeroValue(opts[i].CacheArtifactNames) {
			q = q.Arg("cacheArtifactNames", opts[i].CacheArtifactNames)
		}
		// `cacheArtifacts` optional argument
		if !querybuilder.IsZeroValue(opts[i].CacheArtifacts) {
			q = q.Arg("cacheArtifacts", opts[i].CacheArtifacts)
		}
	}
	q = q.Arg("cmds", cmds)
...
func (r *Node) Pipeline(ctx context.Context, opts ...NodePipelineOpts) (string, error) {
	...
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `testFolderArtifactNames` optional argument
		if !querybuilder.IsZeroValue(opts[i].TestFolderArtifactNames) {
			q = q.Arg("testFolderArtifactNames", opts[i].TestFolderArtifactNames)
		}
		// `testFolderArtifacts` optional argument
		if !querybuilder.IsZeroValue(opts[i].TestFolderArtifacts) {
			q = q.Arg("testFolderArtifacts", opts[i].TestFolderArtifacts)
		}
		// `testFileArtifactNames` optional argument
		if !querybuilder.IsZeroValue(opts[i].TestFileArtifactNames) {
			q = q.Arg("testFileArtifactNames", opts[i].TestFileArtifactNames)
		}
		// `testFileArtifacts` optional argument
		if !querybuilder.IsZeroValue(opts[i].TestFileArtifacts) {
			q = q.Arg("testFileArtifacts", opts[i].TestFileArtifacts)
		}
		// `testCacheArtifactNames` optional argument
		if !querybuilder.IsZeroValue(opts[i].TestCacheArtifactNames) {
			q = q.Arg("testCacheArtifactNames", opts[i].TestCacheArtifactNames)
		}
		// `testCacheArtifacts` optional argument
		if !querybuilder.IsZeroValue(opts[i].TestCacheArtifacts) {
			q = q.Arg("testCacheArtifacts", opts[i].TestCacheArtifacts)
		}
		// `ociFolderArtifactNames` optional argument
		if !querybuilder.IsZeroValue(opts[i].OciFolderArtifactNames) {
			q = q.Arg("ociFolderArtifactNames", opts[i].OciFolderArtifactNames)
		}
		// `ociFolderArtifacts` optional argument
		if !querybuilder.IsZeroValue(opts[i].OciFolderArtifacts) {
			q = q.Arg("ociFolderArtifacts", opts[i].OciFolderArtifacts)
		}
		// `ociFileArtifactNames` optional argument
		if !querybuilder.IsZeroValue(opts[i].OciFileArtifactNames) {
			q = q.Arg("ociFileArtifactNames", opts[i].OciFileArtifactNames)
		}
		// `ociFileArtifacts` optional argument
		if !querybuilder.IsZeroValue(opts[i].OciFileArtifacts) {
			q = q.Arg("ociFileArtifacts", opts[i].OciFileArtifacts)
		}
...
func (r *Node) Test(opts ...NodeTestOpts) *Node {
